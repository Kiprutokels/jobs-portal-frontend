  ...
  return (
    <div className="space-y-6">
      <div className="animate-fade-in">
        ...
        <p className="text-muted-foreground">Configure email settings and templates</p>
      </div>
          ...
          <Card className="shadow-card">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="fromEmail" type="email" placeholder="noreply@careerhub.com" />
              </div>
              <div className="space-y-2">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">Confirm when candidate applies to a job</p>
                </div>
                <Switch defaultChecked />
              </div>
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">Notify employers when job is approved</p>
                </div>
                <Switch defaultChecked />
              </div>
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">Alert employers of new applications</p>
                </div>
                <Switch defaultChecked />
              </div>
              <div className="flex items-center justify-between">
          ...
          <Card className="shadow-card">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="templateSubject" placeholder="Welcome to {{site_name}}!" />
              </div>
              <div className="space-y-2">
              ...
              <div className="p-4 bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg">
                <h4 className="font-medium text-sm mb-2 text-blue-900 dark:text-blue-100">Available Variables</h4>
