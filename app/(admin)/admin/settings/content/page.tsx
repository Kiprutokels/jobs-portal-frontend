...
export default function ContentSettings() {
  ...
  const pages = [
    ...
    { id: "2", title: "Privacy Policy", slug: "privacy", lastModified: "1 week ago" },
    { id: "3", title: "Terms of Service", slug: "terms", lastModified: "1 week ago" },
    { id: "4", title: "Contact Us", slug: "contact", lastModified: "3 days ago" },
  ];

  const blogPosts = [
    { id: "1", title: "10 Tips for Job Seekers in 2024", status: "published", date: "Mar 15, 2024" },
    { id: "2", title: "How to Write a Winning Resume", status: "published", date: "Mar 10, 2024" },
    { id: "3", title: "Interview Preparation Guide", status: "draft", date: "Mar 18, 2024" },
  ];
  ...
  return (
    <div className="space-y-6">
      <div className="animate-fade-in">
        ...
        <p className="text-muted-foreground">Manage static pages and blog content</p>
      </div>
                ...
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">Last modified {page.lastModified}</p>
                    </div>
          ...
          <Card className="shadow-card">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-muted-foreground">Supports Markdown and HTML</p>
              </div>
